...
RUM_CIPHERKEY = "bca953e6b5062f3280cf447d4e821419d77497e55514c9b37ba1aace89fb4e2c"  # 从 seed 中解析得出
...
RUMPY_PATH = os.path.join(CODE_DIR, "rumpy")  # git clone https://github.com/liujuanjuan1984/rumpy
MIXIN_SDK_PATH = os.path.join(
    CODE_DIR, "mixin-sdk-python"
